...
//Fillblankimages
var fillBlankImagesWorkspaces=document.querySelectorAll('.workspace.fillblankimages-draggable');_.forEach(fillBlankImagesWorkspaces,function(fillBlankImagesWorkspace){var fbiDraggableZones=fillBlankImagesWorkspace.querySelectorAll('.droppable-container');var fbiDraggableDivsElement=document.createElement('div');fbiDraggableDivsElement.className="sm-draggable-images";_.forEach(fbiDraggableZones,function(elemento){//find text
