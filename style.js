...
text=(0,_getTextOfNode.getTextOfNode)(elemento.nextElementSibling);}if(elemento.previousElementSibling){//!text && 
...
text=(0,_getTextOfNode.getTextOfNode)(elemento.parentElement.nextElementSibling);}if(elemento.parentElement.previousElementSibling){//!text && 
...
console.log("Creando mutante");var revisionModeBarUpdate=function revisionModeBarUpdate(){var labelEl=document.querySelector('.modo_revision .nota_revision>label');var inputEl=document.querySelector('.modo_revision .nota_revision .revision_container input');if(inputEl.classList.contains('r_suspenso')){labelEl.classList.add('sm-r_suspenso');}else{labelEl.classList.remove('sm-r_suspenso');}};var revisionModeBarObserver=new MutationObserver(function(mutationsList,observer){revisionModeBarUpdate();});revisionModeBarObserver.observe(document.querySelector('.modo_revision .nota_revision .revision_container input'),{attributes:true});revisionModeBarUpdate();this.update();}_createClass(Activities,[{key:'update',value:function update(){////l('Activities.update()');
