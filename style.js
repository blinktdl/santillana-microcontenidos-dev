...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var config={dev:false,//window.location.hash == '#dev',
// velocityFast: 100,
velocity:200,velocitySlow:400,velocityTransitions:600,easingTransitionOut:'easeOutCubic',easingTransitionLinear:'linear',slideTypes:[{name:'Respuesta múltiple',number:2},{name:'Verdadero / Falso',number:4},{name:'Arrastrar',number:5},{name:'Rellenar espacios',number:6},{name:'Arrastrar imágenes',number:31},{name:'Cálculo numérico',number:9},{name:'Relacionar',number:10},{name:'Ordenar',number:12},{name:'Clasificar',number:13},{name:'Análisis sintáctico',number:17},{name:'Señalar respuesta',number:18},{name:'Test',number:19},{name:'Rellenar espacios y Señalar respuesta (mixed)',number:26},{name:'Redacción',number:8},{name:'Dictado',number:14},{name:'Respuestas cortas',number:11},{name:'Velocidad de lectura',number:20},{name:'Grabación de sonido',number:25},{name:'Dibujo',number:29},{name:'Palabras cruzadas',number:21},{name:'Sopa de letras',number:22},{name:'Crucigrama',number:23},{name:'Memory',number:28},{name:'Archivo entregable',number:27}]};exports.default=config;
...
module.exports = "<div class=sm-subunit-start__actividades__item> <div class=sm-subunit-start__actividades__item__icon> <svg height=79 viewBox=\"0 0 76 79\" width=76 xmlns=http://www.w3.org/2000/svg><g fill=none transform=\"translate(.723 .46)\"><ellipse cx=37.518 cy=38.854 fill=#97b8cf rx=37.518 ry=38.854 /><path d=\"m74.9151365 42.2563134c-1.6669107 19.8647276-17.7563951 35.4511436-37.3730063 35.4511436-.4590086 0-.9180173 0-1.377026-.0250425l-17.7563951-18.3885894 32.2031503-42.2062285z\" fill=#7596ad /><path d=\"m20.0756199 16.2369124h28.5309344c1.5461499 0 2.8024149 1.3009928 2.8024149 2.9021914v17.3128268 4.1030145 14.5607383 1.2509079c0 1.9514892-1.5219683 3.5276453-3.4063659 3.5276453h-27.9269834c-1.5461499 0-2.8024149-1.3009928-2.8024149-2.9021913v-37.8529415c0-1.6011986 1.2564116-2.9021914 2.8024149-2.9021914z\" fill=#ffd630 /><path d=\"m19.085 17.938h30.512v40.23h-30.512z\" fill=#f7f7f8 /><g fill=#e84f4f transform=\"translate(21.544 21.096)\"><ellipse cx=32.643 cy=29.367 rx=9.616 ry=9.958 /><path d=\"m.02989712.14433553h3.93777251v4.70342596h-3.93777251zm0 25.26873477h3.93777251v4.703426h-3.93777251zm0-8.431259h3.93777251v4.7034259h-3.93777251zm0-8.43125913h3.93777251v4.70342593h-3.93777251z\"/></g><path d=\"m27.3713954 22.9669549h13.4561933v1.2260173h-13.4561933zm0 25.2687348h13.4561933v1.2260173h-13.4561933zm0-8.431259h13.4561933v1.2260172h-13.4561933zm0-8.4312591h13.4561933v1.2260172h-13.4561933z\" fill=#999 /><ellipse cx=54.187 cy=50.463 fill=#ffd630 rx=8.118 ry=8.407 /><path d=\"m47.3262543 50.7375056 2.5850746-.3002058 2.8024149 2.5769432s1.3529911-5.8543159 7.6823862-7.230436c-3.0922996 1.726259-5.0007322 5.1538864-6.2811787 9.8823548-.3140663 1.200823-1.1595391.8755748-1.425389.5252842-.4348271-.5755209-3.3338214-4.0029965-5.3631614-5.4791346v.0251942z\" fill=#fff /><path d=\"m31.6474156 13.7851815h.4348272c-.1207609-.200036-.1931588-.4503087-.1931588-.7004296v-1.5011805c0-.8256418.7248585-1.5010289 1.6185477-1.5010289h1.6669108c.8938358 0 1.6185477.6755389 1.6185477 1.5010289v1.5010288c0 .2502726-.0723979.475351-.1933053.7004295h.4348271c2.9715388 0 5.3871964 2.2767374 5.3871964 5.0286741h-16.1857707c0-2.7769791 2.4399857-5.0286741 5.3871964-5.0286741h.0241815z\" fill=#e84f4f /><path d=\"m34.3532511 10.0823908h.8454729c.8938358 0 1.6185477.6755388 1.6185477 1.5010288v1.5010288c0 .2502726-.0723979.4753511-.1933054.7004295h.4348272c2.9715388 0 5.3871964 2.2767374 5.3871964 5.0286742h-8.0930319z\" fill=#c94545 /></g></svg> </div> <div class=sm-subunit-start__actividades__item__type>Tipo de recurso</div> <div class=sm-subunit-start__actividades__item__title>Nombre de la actividad</div> </div>";
...
"use strict";
__webpack_require__(42);var _app=__webpack_require__(39);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){SantillanaMicrocontenidosApp.init(data);}};
