...
document.querySelector('.navbar.libro').insertAdjacentHTML('afterbegin',replaceStringInTemplates.replace(_subUnitBackButton2.default));document.querySelector('#sm-subunit-backbutton').addEventListener('click',this.onBackButtonClick.bind(this));//If preview or review
...
document.querySelector('.navbar.libro').classList.add('is-preview');//remove all elements of title less last span.ellipsis
...
var reviewElements=document.querySelectorAll('.review');_.forEach(reviewElements,function(reviewEl){return reviewEl.style.display='none';});}//Activities
