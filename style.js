...
document.querySelector('.sm-subunit-start__actividades__list').insertAdjacentHTML('beforeend',_subUnitStartActivitiesItem2.default);var activityDomElement=document.querySelectorAll('.sm-subunit-start__actividades__list .sm-subunit-start__actividades__item')[index];activityDomElement.querySelector('.sm-subunit-start__actividades__item__icon').classList.add('activity_type_'+activity.type);activityDomElement.querySelector('.sm-subunit-start__actividades__item__type').innerHTML=activity.typeName;activityDomElement.querySelector('.sm-subunit-start__actividades__item__title').innerHTML=activity.title;activityDomElement.addEventListener('click',function(){_this.onGoToActivity(activity.page);});});}else{//Evaluación final
if(this.subUnitObject.image.length>3){document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__image').style.backgroundImage='url('+this.subUnitObject.image+')';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__evaluacion__background').style.backgroundImage='url('+this.subUnitObject.image+')';}else{document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__image').style.backgroundImage='url('+this.subUnitObject.parentSubUnit.image+')';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__evaluacion__background').style.backgroundImage='url('+this.subUnitObject.parentSubUnit.image+')';}document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__number').innerHTML=numberString;document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__title').innerHTML=this.subUnitObject.title;var _completedSecuencia=this.subUnitObject.completado||0;document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__progress__title').innerHTML=_completedSecuencia+'% completado';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__progress__bar .sm-color-background-color').style.width=_completedSecuencia+'%';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__start_button_content--general .sm-subunit-start__start_button').addEventListener('click',function(){return _this.goFirstBlinkSlide();});}//htmlSubUnitStartActivitiesItem
...
},{key:'showEvaluacion',value:function showEvaluacion(){if(_config2.default.dev)console.log("Mostrando evaluación");document.querySelector('.sm-subunit-start__secuencia').style.display='none';document.querySelector('.sm-subunit-start__evaluacion').style.display='block';document.querySelector('.sm-subunit-start__nav__actions').style.display='none';this.state.tab='evaluacion';}}]);return ScreenSubUnitStart;}();exports.default=ScreenSubUnitStart;
...
this.screenSubUnitStart.init(this.subUnitObject,this.number,this.isEvaluacion);this.screenSubUnitStart.goFirstBlinkSlide=function(){return _this.screenSubUnitIndicators.goFirstBlinkSlide();};this.screenSubUnitStart.onGoToActivity=this.onGoToActivity.bind(this);//Navigation
...
unitData.subunitsevaluation.forEach(function(subunit,index){if(subunit.id==''+idclase){subunitObject=subunit;subunitIndex=index;unit=unitData;isEvaluacion=true;}});});//Copy slides (sections) of this types to Activities Tab
