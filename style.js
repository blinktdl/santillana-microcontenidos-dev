...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _getCoords=__webpack_require__(14);var _sliderIndicatorArrowLeft=__webpack_require__(13);var _sliderIndicatorArrowLeft2=_interopRequireDefault(_sliderIndicatorArrowLeft);var _sliderIndicatorArrowRight=__webpack_require__(12);var _sliderIndicatorArrowRight2=_interopRequireDefault(_sliderIndicatorArrowRight);var _sliderIndicatorStartButton=__webpack_require__(11);var _sliderIndicatorStartButton2=_interopRequireDefault(_sliderIndicatorStartButton);var _sliderIndicatorEndButton=__webpack_require__(10);var _sliderIndicatorEndButton2=_interopRequireDefault(_sliderIndicatorEndButton);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitIndicators=function(){function ScreenSubUnitIndicators(){_classCallCheck(this,ScreenSubUnitIndicators);this.state={started:false,contentLeft:0,isStartSlide:false,isEndSlid:false,blinkSlidesLength:0};}_createClass(ScreenSubUnitIndicators,[{key:'init',value:function init(){// if(config.dev)
//     console.log("ScreenSubUnitIndicators.Init");
if(!this.started){//Apply book colors with class
...
// });
//Refresh on resize
window.addEventListener('resize',this.update.bind(this),false);}this.started=true;this.update();}},{key:'update',value:function update(){var content=document.querySelector('.navbar-bottom ol.slider-indicators');this.state.contentLeft=this.contentLeftLimit(this.state.contentLeft);content.style.left=this.state.contentLeft+'px';}},{key:'onArrowLeftClick',value:function onArrowLeftClick(){document.querySelectorAll('.slider-indicators li').forEach(function(element){element.classList.remove('active');});if(!this.state.isStartSlide){//If is the first slide (0)
...
this.onEndShow();}}},{key:'jumpTo',value:function jumpTo(nextContentLeft){nextContentLeft=this.contentLeftLimit(nextContentLeft);var _this=this;(0,_animejs2.default)({targets:_this.state,contentLeft:nextContentLeft,duration:_config2.default.velocityTransitions,easing:_config2.default.easingTransitionOut,round:1,update:function update(){_this.update();}});}},{key:'onSliderIndicatorClick',value:function onSliderIndicatorClick(activeButton){document.querySelectorAll('.slider-indicators li').forEach(function(element){if(activeButton!=element){element.classList.remove('active');}});this.state.isStartSlide=false;this.state.isEndSlide=false;//Check if active is not visible
if(this.isOutside(activeButton)){var activeButtonWidth=activeButton.clientWidth;var activeButtonOffsetCenter=activeButton.offsetLeft+activeButtonWidth*0.5;var container=document.querySelector('.navbar-bottom');var containerWidth=container.clientWidth;var containerWidthCenter=containerWidth*0.5;var nextContentLeft=containerWidthCenter-activeButtonOffsetCenter;this.jumpTo(nextContentLeft);}}},{key:'isOutside',value:function isOutside(activeButton){var activeButtonWidth=activeButton.clientWidth;var leftPos=(0,_getCoords.getCoords)(activeButton).left;var container=document.querySelector('.navbar-bottom');var containerWidth=container.clientWidth;return leftPos<14||leftPos+activeButtonWidth>containerWidth-14;}//Be sure this.state.contentLeft is not ouuside limit
...
nextContentLeft=nextContentLeft<=0?nextContentLeft:0;nextContentLeft=contentWidth+nextContentLeft>containerWidth?nextContentLeft:containerWidth-contentWidth;return nextContentLeft;}}]);return ScreenSubUnitIndicators;}();exports.default=ScreenSubUnitIndicators;
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _urlHelper=__webpack_require__(33);var _urlHelper2=_interopRequireDefault(_urlHelper);var _Transitions=__webpack_require__(32);var _Transitions2=_interopRequireDefault(_Transitions);var _1ScreenHome=__webpack_require__(30);var _1ScreenHome2=_interopRequireDefault(_1ScreenHome);var _2ScreenUnitsMenu=__webpack_require__(27);var _2ScreenUnitsMenu2=_interopRequireDefault(_2ScreenUnitsMenu);var _3ScreenUnit=__webpack_require__(24);var _3ScreenUnit2=_interopRequireDefault(_3ScreenUnit);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}//El hash puede ser
// "#" o "#" => Home
...
//Polyfils
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _router=__webpack_require__(34);var _router2=_interopRequireDefault(_router);var _bookColors=__webpack_require__(23);var _ImagesPreload=__webpack_require__(22);var _ImagesPreload2=_interopRequireDefault(_ImagesPreload);var _0LeftMenu=__webpack_require__(21);var _0LeftMenu2=_interopRequireDefault(_0LeftMenu);var _ScreenSubUnit=__webpack_require__(16);var _ScreenSubUnit2=_interopRequireDefault(_ScreenSubUnit);var _main=__webpack_require__(9);var _main2=_interopRequireDefault(_main);__webpack_require__(8);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var SantillanaMicrocontenidos=function(){function SantillanaMicrocontenidos(){_classCallCheck(this,SantillanaMicrocontenidos);this.state={book:{}};this.leftMenu=null;}_createClass(SantillanaMicrocontenidos,[{key:'init',value:function init(data){if(_config2.default.dev){console.log('%c Iniciando estilos Santillana ','background: #29495e; color: white');console.log('%c Unidades: '+data.units.length+' ','background: #29495e; color: white');}var urlSeguimiento='/include/javascript/seguimientoCurso.js.php?idcurso='+idcurso;loadScript(urlSeguimiento,true,function(){this.initAfertLoadsActivities(data,window.actividades);}.bind(this));}},{key:'initAfertLoadsActivities',value:function initAfertLoadsActivities(data,activities){var isFirstSubunit=idclase==data.units[0].subunits[0].id;if(_config2.default.dev){console.log('%c Activities loaded. ','background: #29495e; color: white');}//Get home image
...
document.getElementsByTagName('body')[0].classList.add('santillana_microcontenidos_menu');(0,_bookColors.setBookColor)();//PreloadImages
...
}else{if(_config2.default.dev)console.log('NO es la actividad Portada');if(_config2.default.dev)console.log(data);this.ScreenSubUnit=new _ScreenSubUnit2.default();this.ScreenSubUnit.init();(0,_bookColors.setBookColor)();}//Menú
...
"use strict";
__webpack_require__(38);var _app=__webpack_require__(35);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){SantillanaMicrocontenidosApp.init(data);}};
