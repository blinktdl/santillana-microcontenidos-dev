...
module.exports = "<div id=sm-left-menu__background></div> <div id=sm-left-menu> <div class=\"sm-left-menu--level1 sm-color-background-color_before\"> <div class=sm-left-menu--image></div> <div class=sm-left-menu--title></div> <div class=sm-left-menu--arrow> <svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink width=10 height=16 viewBox=\"0 0 10 16\"> <path d=\"M0.413623017,0.411885438 C0.968407485,-0.137295146 1.8619621,-0.137295146 2.41674657,0.411885438 L10,7.91854035 L2.41674657,15.4251953 C1.8619621,15.9743759 0.968407485,15.9743759 0.413623017,15.4251953 C0.410269289,15.4218754 0.406932428,15.4185386 0.403612562,15.4151849 C-0.138421122,14.8676249 -0.13394118,13.9843347 0.413618791,13.442301 L5.99369679,7.91854035 L0.413618791,2.39477968 C0.410265077,2.39145982 0.40692823,2.38812296 0.403608378,2.38476923 C-0.138422971,1.83720695 -0.133939265,0.953916788 0.413623017,0.411885438 Z\"/> </svg> </div> </div> <a class=\"sm-left-menu--level2 sm-color-background-color_before sm-color-color--pressed\"> <div class=sm-left-menu--image></div> <div class=sm-left-menu--title></div> <div class=sm-left-menu--arrow> <svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink width=10 height=16 viewBox=\"0 0 10 16\"> <path d=\"M0.413623017,0.411885438 C0.968407485,-0.137295146 1.8619621,-0.137295146 2.41674657,0.411885438 L10,7.91854035 L2.41674657,15.4251953 C1.8619621,15.9743759 0.968407485,15.9743759 0.413623017,15.4251953 C0.410269289,15.4218754 0.406932428,15.4185386 0.403612562,15.4151849 C-0.138421122,14.8676249 -0.13394118,13.9843347 0.413618791,13.442301 L5.99369679,7.91854035 L0.413618791,2.39477968 C0.410265077,2.39145982 0.40692823,2.38812296 0.403608378,2.38476923 C-0.138422971,1.83720695 -0.133939265,0.953916788 0.413623017,0.411885438 Z\"/> </svg> </div> </a> </div>";
...
var suUlElement=document.createElement('ul');unit.subunitsmain.forEach(function(subunit,index){var subUnitElement=level2DomElement.cloneNode(true);if(subunit.image){subUnitElement.querySelector('.sm-left-menu--image').style.backgroundImage='url('+subunit.image+')';}subUnitElement.querySelector('.sm-left-menu--title').innerHTML='<span>'+('0'+(index+1)).slice(-2)+'</span> '+subunit.title;subUnitElement.setAttribute('href',subunit.url);var suLiElement=document.createElement('li');suLiElement.appendChild(subUnitElement);suUlElement.appendChild(suLiElement);});liElement.appendChild(suUlElement);ulLevel1DomElement.appendChild(liElement);});document.querySelector('#sm-left-menu').appendChild(ulLevel1DomElement);document.querySelector('#sm-left-menu__background').addEventListener('click',this.closeMenu);this.perfectScrollbar=new _perfectScrollbar2.default('#sm-left-menu',{// wheelSpeed: 2,
// wheelPropagation: true,
...
new _router2.default(data);//Else show content of subunit
