...
var iFramesInHtmlBook=document.querySelectorAll('.html-book iframe');iFramesInHtmlBook.forEach(function(iframe){var iFrameRef=iframe.contentWindow?iframe.contentWindow.document:iframe.contentDocument;//iFrameRef.document.body.style.backgroundColor = 'white';
