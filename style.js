...
this.update();}_createClass(Activities,[{key:'update',value:function update(){(0,_debug.cl)('Activities.update()');//Activitie header book color small block
...
}else if(this.subUnitObject.image.length>3){(0,_debug.cl)("Tiene imagen");document.querySelector('.sm-subunit-start').style.backgroundImage='url('+this.subUnitObject.image+')';}//Secuencia didáctica
...
if(this.subUnitObject.video.length>3){(0,_debug.cl)("Tiene video");var videoElement=document.createElement("VIDEO");var imageElement=document.createElement("DIV");imageElement.style.backgroundImage='url('+this.subUnitObject.image+')';videoElement.setAttribute('src',this.subUnitObject.video);videoElement.setAttribute('autoplay','autoplay');videoElement.setAttribute('loop','loop');videoElement.appendChild(imageElement);document.querySelector('.sm-subunit-start').appendChild(videoElement);}else if(this.subUnitObject.image.length>3){(0,_debug.cl)("Tiene imagen");document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__image').style.backgroundImage='url('+this.subUnitObject.image+')';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__evaluacion__background').style.backgroundImage='url('+this.subUnitObject.image+')';}else{(0,_debug.cl)("No tiene imagen");document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__image').style.backgroundImage='url('+this.subUnitObject.parentSubUnit.image+')';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__evaluacion__background').style.backgroundImage='url('+this.subUnitObject.parentSubUnit.image+')';}document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__number').innerHTML=numberString;document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__title').innerHTML=this.subUnitObject.title;this.updateCompleted();document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__start_button_content--general .sm-subunit-start__start_button').addEventListener('click',function(){return _this.goFirstBlinkSlide();});}//Añade acciones a los botones tabs
