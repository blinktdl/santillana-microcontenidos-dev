...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _subUnitEnd=__webpack_require__(11);var _subUnitEnd2=_interopRequireDefault(_subUnitEnd);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitEnd=function(){function ScreenSubUnitEnd(){_classCallCheck(this,ScreenSubUnitEnd);this.state={isVisible:true};this.subUnitObject={};}_createClass(ScreenSubUnitEnd,[{key:'init',value:function init(subUnitObject){this.subUnitObject=subUnitObject;document.getElementsByTagName('body')[0].insertAdjacentHTML('beforeend',_subUnitEnd2.default);}},{key:'show',value:function show(){document.querySelector('.sm-subunit-end').classList.add('active');this.state.isVisible=true;}},{key:'hide',value:function hide(){document.querySelector('.sm-subunit-end').classList.remove('active');this.state.isVisible=false;}}]);return ScreenSubUnitEnd;}();exports.default=ScreenSubUnitEnd;
...
this.screenSubUnitEnd.init(this.subUnitObjectn);this.screenSubUnitEnd.goFirstBlinkSlide=function(){return _this.screenSubUnitIndicators.goFirstBlinkSlide();};this.screenSubUnitEnd.goLastBlinkSlide=function(){return _this.screenSubUnitIndicators.goLastBlinkSlide();};//Navigation
