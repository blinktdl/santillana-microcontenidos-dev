...
module.exports = "<div class=\"sm-subunit-start sm-base\"> <div class=sm-subunit-start__secuencia> <div class=sm-subunit-start__secuencia__content> <div class=sm-subunit-start__number></div> <div class=sm-subunit-start__title></div> <div class=sm-subunit-start__progress> <div class=sm-subunit-start__progress__title></div> <div class=sm-subunit-start__progress__bar> <div class=sm-color-background-color></div> </div> </div> <div class=sm-subunit-start__start_button>Comienza secuencia didáctica</div> </div> </div> <div class=sm-subunit-start__nav> <div class=sm-dropdown-group> <div class=sm-subunit-start__nav__select> <div>Secuencia Didáctiva</div> <svg xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink width=16 height=10 viewBox=\"0 0 16 10\"> <path d=\"M15.4251953,0.413623017 C15.9743759,0.968407485 15.9743759,1.8619621 15.4251953,2.41674657 L7.91854035,10 L0.411885438,2.41674657 C-0.137295146,1.8619621 -0.137295146,0.968407485 0.411885438,0.413623017 C0.41520529,0.410269289 0.418542137,0.406932428 0.421895851,0.403612562 C0.969455822,-0.138421122 1.852746,-0.13394118 2.39477968,0.413618791 L7.91854035,5.99369679 L13.442301,0.413618791 C13.4456209,0.410265077 13.4489577,0.40692823 13.4523115,0.403608378 C13.9998738,-0.138422971 14.8831639,-0.133939265 15.4251953,0.413623017 Z\"/> </svg> </div> <div class=sm-subunit-start__nav__options> <div class=active>Secuencia Didáctiva</div> <div>Actividades</div> <div>Ir a evaluación final</div> </div> </div> </div> </div>";
...
//Templates
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _dropdown=__webpack_require__(11);var _dropdown2=_interopRequireDefault(_dropdown);var _subUnitStart=__webpack_require__(10);var _subUnitStart2=_interopRequireDefault(_subUnitStart);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitStart=function(){function ScreenSubUnitStart(){_classCallCheck(this,ScreenSubUnitStart);this.state={};this.subUnitObject={};}_createClass(ScreenSubUnitStart,[{key:'init',value:function init(subUnitObject){this.subUnitObject=subUnitObject;document.getElementsByTagName('body')[0].insertAdjacentHTML('beforeend',_subUnitStart2.default);document.querySelector('.sm-subunit-start').style.backgroundImage='url('+this.subUnitObject.image+')';this.dropdown=new _dropdown2.default();this.dropdown.init(document.querySelector('.sm-subunit-start__nav .sm-dropdown-group'));}},{key:'show',value:function show(){document.querySelector('.sm-subunit-start').classList.add('active');}},{key:'hide',value:function hide(){document.querySelector('.sm-subunit-start').classList.remove('active');}}]);return ScreenSubUnitStart;}();exports.default=ScreenSubUnitStart;
...
nextContentTop=nextContentTop<=0?nextContentTop:0;nextContentTop=contentHeight+nextContentTop>containerHeight?nextContentTop:containerHeight-contentHeight;return nextContentTop;}}]);return ScreenSubUnitIndicators;}();exports.default=ScreenSubUnitIndicators;
...
var subunitObject={};data.units.forEach(function(unit){var subUnitFound=_.find(unit.subunitsmain,{id:''+idclase});subunitObject=subUnitFound||subunitObject;});this.ScreenSubUnit=new _ScreenSubUnit2.default();this.ScreenSubUnit.init(subunitObject);}(0,_bookColors.setBookColor)();//Menú
