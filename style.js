...
var tooltips=document.querySelectorAll('.sm-actividades .bck-tooltip');tooltips.forEach(function(tooltip){tooltip.classList.add('sm-color-color');});this.update();}_createClass(Activities,[{key:'update',value:function update(){//Activitie header book color small block
