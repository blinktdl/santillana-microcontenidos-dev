...
console.log('**************************************************  ScreenSubUnit');blink.getActivity(68,1179).done(function(e){return console.log(e,'asdassd, r');});console.log(blink.getActivity(68,1179));console.log(unit,book);if(!this.started){this.number=number;this.subUnitObject=subUnitObject;this.unit=unit;this.book=book;this.isEvaluacion=isEvaluacion;this.screenSubUnitStart=new _ScreenSubUnitStart2.default();this.screenSubUnitEnd=new _ScreenSubUnitEnd2.default();this.screenSubUnitIndicators=new _ScreenSubUnitSliderIndicators2.default();//StartPage
