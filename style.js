...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _getCoords=__webpack_require__(12);var _sliderIndicatorArrowLeft=__webpack_require__(11);var _sliderIndicatorArrowLeft2=_interopRequireDefault(_sliderIndicatorArrowLeft);var _sliderIndicatorArrowRight=__webpack_require__(10);var _sliderIndicatorArrowRight2=_interopRequireDefault(_sliderIndicatorArrowRight);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitIndicators=function(){function ScreenSubUnitIndicators(){_classCallCheck(this,ScreenSubUnitIndicators);this.state={started:false,contentLeft:0};}_createClass(ScreenSubUnitIndicators,[{key:'init',value:function init(){// if(config.dev)
//     console.log("ScreenSubUnitIndicators.Init");
if(!this.started){//Add Inicio and Fin buttons, and apply book colors with class
var slidesNaveButtons=document.querySelectorAll('.navbar-bottom ol.slider-indicators li.slider-indicator');slidesNaveButtons.forEach(function(slideButton,index){slideButton.classList.add('sm-color-background-color--active');slideButton.classList.add('sm-color-border-color--active');var textInButton=index;if(index==0){textInButton='Inicio';slideButton.classList.add('sm-big');}else if(index==slidesNaveButtons.length-1){textInButton='Fin';slideButton.classList.add('sm-big');}slideButton.innerHTML=textInButton;});// Add arrows
...
var sliderIndicatorButtons=document.querySelectorAll('.navbar-bottom .slider-indicators .slider-indicator');var _this=this;_.forEach(sliderIndicatorButtons,function(button){button.addEventListener('click',function(e){_this.onSliderIndicatorClick(e.currentTarget);});});//Left and right slider (blink) buttons
var leftSliderControlButton=document.querySelector('.left.slider-control');var rightSliderControlButton=document.querySelector('.right.slider-control');leftSliderControlButton.addEventListener('click',function(e){var activeSliderIndicatorButton=document.querySelector('.navbar-bottom ol.slider-indicators .slider-indicator.active');var prevButton=activeSliderIndicatorButton.previousElementSibling;if(prevButton){_this.onSliderIndicatorClick(prevButton);}});rightSliderControlButton.addEventListener('click',function(e){var activeSliderIndicatorButton=document.querySelector('.navbar-bottom ol.slider-indicators .slider-indicator.active');var nextButton=activeSliderIndicatorButton.nextElementSibling;if(nextButton){_this.onSliderIndicatorClick(nextButton);}});//Refresh on resize
window.addEventListener('resize',this.update.bind(this),false);}this.started=true;this.update();}},{key:'update',value:function update(){// if(config.dev)
//     console.log("ScreenSubUnitIndicators.update");
var container=document.querySelector('.navbar-bottom');var content=document.querySelector('.navbar-bottom ol.slider-indicators');var leftArrow=document.querySelector('.navbar-bottom .sm-slider-indicator-arrow-left');var rightArrow=document.querySelector('.navbar-bottom .sm-slider-indicator-arrow-right');var containerWidth=container.clientWidth;var contentWidth=content.clientWidth;this.state.contentLeft=this.contentLeftLimit(this.state.contentLeft);if(containerWidth<contentWidth){if(this.state.contentLeft<0){leftArrow.classList.add('active');}else{leftArrow.classList.remove('active');}if(contentWidth+this.state.contentLeft>containerWidth){rightArrow.classList.add('active');}else{rightArrow.classList.remove('active');}}else{leftArrow.classList.remove('active');rightArrow.classList.remove('active');}content.style.left=this.state.contentLeft+'px';}},{key:'onArrowLeftClick',value:function onArrowLeftClick(){var container=document.querySelector('.navbar-bottom');var containerWidth=container.clientWidth;var nextContentLeft=this.state.contentLeft+(containerWidth-40-40);nextContentLeft=this.contentLeftLimit(nextContentLeft);//this.update();
var _this=this;(0,_animejs2.default)({targets:_this.state,contentLeft:nextContentLeft,duration:_config2.default.velocityTransitions,easing:_config2.default.easingTransitionOut,round:1,update:function update(){_this.update();}});}},{key:'onArrowRightClick',value:function onArrowRightClick(){var container=document.querySelector('.navbar-bottom');var containerWidth=container.clientWidth;var nextContentLeft=this.state.contentLeft-(containerWidth-40-40);this.jumpTo(nextContentLeft);}},{key:'jumpTo',value:function jumpTo(nextContentLeft){nextContentLeft=this.contentLeftLimit(nextContentLeft);var _this=this;(0,_animejs2.default)({targets:_this.state,contentLeft:nextContentLeft,duration:_config2.default.velocityTransitions,easing:_config2.default.easingTransitionOut,round:1,update:function update(){_this.update();}});}},{key:'onSliderIndicatorClick',value:function onSliderIndicatorClick(activeButton){//Check if active is not visible
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _urlHelper=__webpack_require__(30);var _urlHelper2=_interopRequireDefault(_urlHelper);var _Transitions=__webpack_require__(29);var _Transitions2=_interopRequireDefault(_Transitions);var _1ScreenHome=__webpack_require__(27);var _1ScreenHome2=_interopRequireDefault(_1ScreenHome);var _2ScreenUnitsMenu=__webpack_require__(24);var _2ScreenUnitsMenu2=_interopRequireDefault(_2ScreenUnitsMenu);var _3ScreenUnit=__webpack_require__(21);var _3ScreenUnit2=_interopRequireDefault(_3ScreenUnit);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}//El hash puede ser
// "#" o "#" => Home
...
}else{if(_config2.default.dev)console.log('NO es la actividad Portada');this.ScreenSubUnit=new _ScreenSubUnit2.default();this.ScreenSubUnit.init();(0,_bookColors.setBookColor)();}//Menú
this.leftMenu=new _0LeftMenu2.default(data);//Global commands to open menú
window.SantillanaMicrocontenidosMenuToggle=this.leftMenu.toggleMenu;window.SantillanaMicrocontenidosMenuOpen=this.leftMenu.openMenu;window.SantillanaMicrocontenidosMenuClose=this.leftMenu.closeMenu;}}]);return SantillanaMicrocontenidos;}();exports.default=SantillanaMicrocontenidos;
...
"use strict";
__webpack_require__(35);var _app=__webpack_require__(32);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){SantillanaMicrocontenidosApp.init(data);}};
