...
// velocityFast: 100,
velocity:200,velocitySlow:400,velocityTransitions:600,easingTransitionOut:'easeOutCubic',easingTransitionLinear:'linear'};exports.default=config;
...
document.querySelector('.sm-subunit-start__actividades .sm-subunit-start__number').innerHTML=numberString;document.querySelector('.sm-subunit-start__actividades .sm-subunit-start__title').innerHTML=this.subUnitObject.title;var completedActividades=this.subUnitObject.completado||0;document.querySelector('.sm-subunit-start__actividades .sm-subunit-start__progress__title').innerHTML=completedActividades+'% completado';document.querySelector('.sm-subunit-start__actividades .sm-subunit-start__progress__bar .sm-color-background-color').style.width=completedActividades+'%';this.dropdown=new _dropdown2.default();this.dropdown.init(document.querySelector('.sm-subunit-start__nav .sm-dropdown-group'));}},{key:'show',value:function show(){document.querySelector('.sm-subunit-start').classList.add('active');}},{key:'hide',value:function hide(){document.querySelector('.sm-subunit-start').classList.remove('active');}}]);return ScreenSubUnitStart;}();exports.default=ScreenSubUnitStart;
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _responsiveStatus=__webpack_require__(2);var _responsiveStatus2=_interopRequireDefault(_responsiveStatus);var _getCoords=__webpack_require__(17);var _sliderIndicatorArrowLeft=__webpack_require__(16);var _sliderIndicatorArrowLeft2=_interopRequireDefault(_sliderIndicatorArrowLeft);var _sliderIndicatorArrowRight=__webpack_require__(15);var _sliderIndicatorArrowRight2=_interopRequireDefault(_sliderIndicatorArrowRight);var _sliderIndicatorStartButton=__webpack_require__(14);var _sliderIndicatorStartButton2=_interopRequireDefault(_sliderIndicatorStartButton);var _sliderIndicatorEndButton=__webpack_require__(13);var _sliderIndicatorEndButton2=_interopRequireDefault(_sliderIndicatorEndButton);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitIndicators=function(){function ScreenSubUnitIndicators(){_classCallCheck(this,ScreenSubUnitIndicators);this.state={started:false,contentLeft:0,//tablet y mobile
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _urlHelper=__webpack_require__(36);var _urlHelper2=_interopRequireDefault(_urlHelper);var _Transitions=__webpack_require__(35);var _Transitions2=_interopRequireDefault(_Transitions);var _1ScreenHome=__webpack_require__(33);var _1ScreenHome2=_interopRequireDefault(_1ScreenHome);var _2ScreenUnitsMenu=__webpack_require__(30);var _2ScreenUnitsMenu2=_interopRequireDefault(_2ScreenUnitsMenu);var _3ScreenUnit=__webpack_require__(27);var _3ScreenUnit2=_interopRequireDefault(_3ScreenUnit);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}//El hash puede ser
// "#" o "#" => Home
...
var subunitObject={};var subunitIndex=-1;data.units.forEach(function(unit){unit.subunitsmain.forEach(function(subunit,index){if(subunit.id==''+idclase){subunitObject=subunit;subunitIndex=index;}});});if(subunitObject==={}){alert("Error:\nNinguna lección con esta id.");}this.ScreenSubUnit=new _ScreenSubUnit2.default();this.ScreenSubUnit.init(subunitObject,subunitIndex+1);}(0,_bookColors.setBookColor)();//Menú
...
"use strict";
__webpack_require__(41);var _app=__webpack_require__(38);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){SantillanaMicrocontenidosApp.init(data);}};
