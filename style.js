...
subUnitElement.querySelector('.sm-left-menu--title em').innerHTML='PRUEBA'+subunit.data.description;subUnitElement.querySelector('.sm-left-menu--title strong').innerHTML=''+subunit.data.title;if(subunit.data.smtype){var tipoTexto='';switch(subunit.data.smtype){case'flipped':tipoTexto=replaceStringInTemplates.replace('--santillana_microcontenidos_flipped--');break;case'microproyecto':tipoTexto=replaceStringInTemplates.replace('--santillana_microcontenidos_microproyecto--');break;case'esencial':tipoTexto=replaceStringInTemplates.replace('--santillana_microcontenidos_esencial--');//Es básica, pero se deja esencial por retrocompatibilidad
break;case'basica':tipoTexto=replaceStringInTemplates.replace('--santillana_microcontenidos_basica--');break;case'reto':tipoTexto=replaceStringInTemplates.replace('--santillana_microcontenidos_reto--');break;default:break;}subUnitElement.querySelector('.sm-left-menu--title small').innerHTML=''+tipoTexto.toLowerCase();}});});});}}]);return LeftMenu;}();exports.default=LeftMenu;
