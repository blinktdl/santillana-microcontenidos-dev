...
this.screenSubUnitStart.init(this.subUnitObject,this.number);this.screenSubUnitStart.goFirstBlinkSlide=function(){return _this.screenSubUnitIndicators.goFirstBlinkSlide();};//Navigation
...
document.getElementsByTagName('body')[0].insertAdjacentHTML('beforeend',_subUnitBackButton2.default);document.querySelector('.sm-subunit-backbutton').addEventListener('click',this.onBackButtonClick.bind(this));}this.started=true;}},{key:'onBackButtonClick',value:function onBackButtonClick(){// Chec if we are in secuencia o actividades
if(this.screenSubUnitStart.state.tab=='actividades'){this.screenSubUnitStart.goTabSecuenciaDidactica();}else if(!this.screenSubUnitStart.state.isVisible){//this.screenSubUnitStart.show();
...
subunitObject.activitiesInTab=[];_.forEach(subunitObject.sections,function(section){var included=false;_.forEach(_config2.default.slideTypes,function(type){if(section.type==type.number){section.typeName=type.name;subunitObject.activitiesInTab.push(section);// included = true;
}});// if(!included){
