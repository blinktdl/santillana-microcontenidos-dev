...
if(document.querySelector('#sm-home h2').innerText.length>5){document.querySelector('#sm-home h2').classList.add('sm-long-text');}}else{document.querySelector('#sm-home h2').style.display='none';}}else{document.querySelector('#sm-home h2').style.display='none';}// **andalucia** >> Grazalema
