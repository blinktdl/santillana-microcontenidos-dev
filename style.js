...
this.screenSubUnitIndicators.onStartShow=function(){return _this.screenSubUnitStart.show();};this.screenSubUnitIndicators.onStartHide=function(){return _this.screenSubUnitStart.hide();};this.screenSubUnitIndicators.onEndShow=function(){console.log("show end");};this.screenSubUnitIndicators.onEndHide=function(){console.log("hide end");};this.screenSubUnitIndicators.init();//backButton
