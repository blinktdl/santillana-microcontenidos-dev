...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _subUnitEnd=__webpack_require__(11);var _subUnitEnd2=_interopRequireDefault(_subUnitEnd);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitEnd=function(){function ScreenSubUnitEnd(){_classCallCheck(this,ScreenSubUnitEnd);this.state={isVisible:true};this.subUnitObject={};}_createClass(ScreenSubUnitEnd,[{key:'init',value:function init(subUnitObject){var _this=this;this.subUnitObject=subUnitObject;document.getElementsByTagName('body')[0].insertAdjacentHTML('beforeend',_subUnitEnd2.default);document.querySelector('.sm-subunit-end').style.backgroundImage='url('+this.subUnitObject.image+')';var completedSecuencia=this.subUnitObject.completado||0;document.querySelector('.sm-subunit-end_completed .sm-subunit-end__progress__title').innerHTML=completedSecuencia+'% completado';document.querySelector('.sm-subunit-end_completed .sm-subunit-end__progress__bar .sm-color-background-color').style.width=completedSecuencia+'%';document.querySelector('.sm-subunit-end_completed .sm-subunit-end__start_button_container .sm-subunit-end__start_button').addEventListener('click',function(){return _this.goFirstBlinkSlide();});}},{key:'show',value:function show(){document.querySelector('.sm-subunit-end').classList.add('active');this.state.isVisible=true;}},{key:'hide',value:function hide(){document.querySelector('.sm-subunit-end').classList.remove('active');this.state.isVisible=false;}}]);return ScreenSubUnitEnd;}();exports.default=ScreenSubUnitEnd;
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();//Templates
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _responsiveStatus=__webpack_require__(2);var _responsiveStatus2=_interopRequireDefault(_responsiveStatus);var _getCoords=__webpack_require__(20);var _sliderIndicatorArrowLeft=__webpack_require__(19);var _sliderIndicatorArrowLeft2=_interopRequireDefault(_sliderIndicatorArrowLeft);var _sliderIndicatorArrowRight=__webpack_require__(18);var _sliderIndicatorArrowRight2=_interopRequireDefault(_sliderIndicatorArrowRight);var _sliderIndicatorStartButton=__webpack_require__(17);var _sliderIndicatorStartButton2=_interopRequireDefault(_sliderIndicatorStartButton);var _sliderIndicatorEndButton=__webpack_require__(16);var _sliderIndicatorEndButton2=_interopRequireDefault(_sliderIndicatorEndButton);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitIndicators=function(){function ScreenSubUnitIndicators(){_classCallCheck(this,ScreenSubUnitIndicators);this.state={started:false,contentLeft:0,//tablet y mobile
contentTop:0,//desktop
isStartSlide:false,isEndSlide:false,blinkSlidesLength:0};this.subunit={};this.line=null;this.lines=null;}_createClass(ScreenSubUnitIndicators,[{key:'init',value:function init(subunit){// if(config.dev)
...
// });
//Create line
this.linesContainer=document.createElement('div');this.linesContainer.setAttribute('class','slider-indicators__lines_container');document.querySelector('.navbar-bottom').insertBefore(this.linesContainer,document.querySelector('.navbar-bottom').firstChild);this.lines={};var buttons=document.querySelectorAll('.navbar-bottom ol.slider-indicators li');for(var index=0;index<buttons.length;index++){var button=buttons[index];var indexNumber=button.getAttribute('data-go-to');if(indexNumber!=null){var isMultimedia=this.subunit.sections[parseInt(indexNumber)+1].type==7;if(isMultimedia){this.lines[index]=document.createElement('div');this.lines[index].setAttribute('class','slider-indicators__lines__line');document.querySelector('.navbar-bottom .slider-indicators__lines_container').appendChild(this.lines[index]);}}}//Create lines
...
if(windowSize!='desktop'){if(windowSize=='mobile'){}else if(windowSize=='tablet-portrait'){buttonsInMiddle=5;}else if(windowSize=='tablet-landscape'){buttonsInMiddle=8;}}else{var huecoHeight=document.querySelector('ol.slider-indicators').offsetHeight-80;if(huecoHeight>450){buttonsInMiddle=2;}if(huecoHeight>600){buttonsInMiddle=4;}if(huecoHeight>800){buttonsInMiddle=6;}}for(var index=-1;index<buttons.length-1;index++){var button=buttons[index+1];//If is not start or end
...
_.forEach(this.lines,function(o,i){if(windowSize!='desktop'){var posLeft=buttons[i].offsetLeft;if(buttons[i].style.display=='inline-block'){o.style.display='block';o.style.left=posLeft+buttons[i].offsetWidth*0.5-1+'px';o.style.top=null;}else{o.style.display='none';}}else{var posTop=buttons[i].offsetTop;if(buttons[i].style.display=='inline-block'){o.style.display='block';o.style.top=posTop+buttons[i].offsetHeight*0.5-1+'px';o.style.left=null;}else{o.style.display='none';}}});}},{key:'onArrowLeftClick',value:function onArrowLeftClick(){// document.querySelectorAll('.slider-indicators li').forEach((element) => {
...
// }
},{key:'goFirstBlinkSlide',value:function goFirstBlinkSlide(){document.querySelector('.slider-indicators li[data-go-to="0"]').click();this.onSliderIndicatorClick(document.querySelector('.slider-indicators li[data-go-to="0"]'));}}]);return ScreenSubUnitIndicators;}();exports.default=ScreenSubUnitIndicators;
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _urlHelper=__webpack_require__(40);var _urlHelper2=_interopRequireDefault(_urlHelper);var _Transitions=__webpack_require__(39);var _Transitions2=_interopRequireDefault(_Transitions);var _1ScreenHome=__webpack_require__(37);var _1ScreenHome2=_interopRequireDefault(_1ScreenHome);var _2ScreenUnitsMenu=__webpack_require__(34);var _2ScreenUnitsMenu2=_interopRequireDefault(_2ScreenUnitsMenu);var _3ScreenUnit=__webpack_require__(30);var _3ScreenUnit2=_interopRequireDefault(_3ScreenUnit);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}//El hash puede ser
// "#" o "#" => Home
...
"use strict";
__webpack_require__(43);var _app=__webpack_require__(42);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){SantillanaMicrocontenidosApp.init(data);}};
