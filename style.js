...
document.onkeydown=smkeydown;function smkeydown(evt){if(!evt)evt=event;if(evt.altKey){var actualClassName=document.body.classList.contains('sm-es-alumno')?'sm-es-alumno':document.body.classList.contains('sm-es-profesor')?'sm-es-profesor':'sm-es-editor';switch(actualClassName){case'sm-es-alumno':document.body.classList.remove('sm-es-alumno');document.body.classList.add('sm-es-profesor');break;case'sm-es-profesor':document.body.classList.remove('sm-es-profesor');document.body.classList.add('sm-es-editor');break;case'sm-es-editor':document.body.classList.remove('sm-es-editor');document.body.classList.add('sm-es-alumno');break;default:break;}console.log("cambiando usuario");}}
...
// 		break;
// }
// activityElement.querySelector('.sm-unit__activity_aside__type--con-tag').innerHTML = `${replaceStringInTemplates.replace('--Metodología--')} <strong>${tipoTexto}</strong>`;
// activityElement.querySelector('.sm-unit__activity_aside__description--con-tag').innerHTML = subunit.description;
