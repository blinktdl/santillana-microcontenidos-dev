...
}this.started=true;this.unit=data.unit;console.log('**************************************************');blink.getActivity(68,1179).done(console.log);console.log(this.unit);this.actionUpdateSubunitOcultar=data.actionUpdateSubunitOcultar;var unitElement=document.getElementById('sm-unit');// Background
