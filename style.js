...
headerElement.querySelector('.sm-unit__header__resources_button').addEventListener('click',function(){var scrollElement=document.querySelector('.sm-content--scrolled');var resourcesContent=scrollElement.querySelector('.sm-unit__activities__aside_container');var resourcesContentRect=resourcesContent.getBoundingClientRect();var scrollTop=window.pageYOffset||document.documentElement.scrollTop;var resourcesContentTop=resourcesContentRect.top+scrollTop-64;(0,_animejs2.default)({targets:scrollElement,scrollTop:resourcesContentTop,duration:500,easing:'easeInOutQuad'});});// Main activities
