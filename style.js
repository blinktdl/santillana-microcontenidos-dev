...
// });
//Create line
this.lines=document.createElement('div');this.lines.setAttribute('class','slider-indicators__lines_container');document.querySelector('.navbar-bottom').appendChild(this.lines);this.line=document.createElement('div');this.line.setAttribute('class','slider-indicators__line');document.querySelector('.navbar-bottom').appendChild(this.line);//Refresh on resize
