...
activityElement.querySelector('.sm-unit__activity_main__actions__pages').innerText=subunit.sections.length+' '+replaceStringInTemplates.replace('--pag--');activityElement.querySelector('.sm-unit__activity_main__actions__send_link').addEventListener('click',function(){openSendActivityHomework(subunit.id,1);});var colorCandado='azul';switch(subunit.lock){case 8:activityElement.querySelector('.sm-unit__activity_main__actions__candado').classList.add('sm-unit__activity_main__actions__candado--cerrado');break;case 16:activityElement.querySelector('.sm-unit__activity_main__actions__candado').classList.add('sm-unit__activity_main__actions__candado--abierto');break;case 2:activityElement.querySelector('.sm-unit__activity_main__actions__candado').classList.add('sm-unit__activity_main__actions__candado--cerrado');activityElement.querySelector('.sm-unit__activity_main__actions__candado').classList.add('sm-unit__activity_main__actions__candado--amarillo');colorCandado='amarillo';break;case 4:activityElement.querySelector('.sm-unit__activity_main__actions__candado').classList.add('sm-unit__activity_main__actions__candado--abierto');activityElement.querySelector('.sm-unit__activity_main__actions__candado').classList.add('sm-unit__activity_main__actions__candado--amarillo');colorCandado='amarillo';break;default:break;}activityElement.querySelector('.sm-unit__activity_main__actions__candado').dataset.idActividad=subunit.id;switch(colorCandado){case'azul':activityElement.querySelector('.sm-unit__activity_main__actions__candado').addEventListener('click',_this.onCandadoAzulClick.bind(_this));break;case'amarillo':activityElement.querySelector('.sm-unit__activity_main__actions__candado').addEventListener('click',_this.onCandadoAmarilloClick.bind(_this));break;default:break;}var completed=subunit.completado||0;activityElement.querySelector('.sm-unit__activity_main__progress__title').innerHTML=completed+'%';activityElement.querySelector('.sm-unit__activity_main__progress__bar .sm-color-background-color').style.width=completed+'%';mainActivitiesContainer.appendChild(activityElement);});// Aside activities
//Dropdown
...
"use strict";
__webpack_require__(51);var _app=__webpack_require__(50);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){console.log("INICIADO.");SantillanaMicrocontenidosApp.init(data);}};//Show loading
