...
console.log(this.screenSubUnitStart.state);if(this.screenSubUnitStart.state.tab=='actividades'){this.screenSubUnitStart.goTabSecuenciaDidactica();}else if(!this.screenSubUnitStart.state.isVisible){this.screenSubUnitStart.show();}else{document.location.href=this.book.url+'#unit_'+this.unit.id;}}}]);return ScreenSubUnit;}();exports.default=ScreenSubUnit;
