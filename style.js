...
(0,_debug.cl)("Create lines");this.line=document.createElement('div');this.line.setAttribute('class','slider-indicators__line');document.querySelector('.navbar-bottom').insertBefore(this.line,document.querySelector('.navbar-bottom').firstChild);//Refresh on resize
window.addEventListener('resize',this.update.bind(this),false);(0,_debug.cl)("this.update");//this.update
this.onStartButtonClick();// this.removeActivitiesSlides();
(0,_debug.cl)("this.update");this.started=true;}(0,_debug.cl)("this.update");this.update();(0,_debug.cl)("ScreenSubUnitIndicators.END");}// removeActivitiesSlides(){
// //Remove Buttons
...
// }
},{key:'goFirstBlinkSlide',value:function goFirstBlinkSlide(){document.querySelector('.slider-indicators li[data-go-to="0"]').click();this.onSliderIndicatorClick(document.querySelector('.slider-indicators li[data-go-to="0"]'));}},{key:'goBlinkSlideWithSection',value:function goBlinkSlideWithSection(section){(0,_debug.cl)('goBlinkSlideWithSection('+section+')');(0,_debug.cl)(this.subunit);this.subunit.sections.forEach(function(sectionObj){if(sectionObj.hasOwnProperty('seccion')&&sectionObj.seccion==section){document.querySelector('.navbar-bottom ol.slider-indicators li.slider-indicator[data-sm-slide-id="'+sectionObj.ID+'"]').click();}});}}]);return ScreenSubUnitIndicators;}();exports.default=ScreenSubUnitIndicators;
