...
var multimediaSlides=document.querySelectorAll('.class_slide.slide_content_type_7');multimediaSlides.forEach(function(slide){var img=slide.querySelector('.multimedia-container img');var src=img.src;var slideMain=slide.querySelector('.slide_main');slideMain.style.backgroundImage='url('+src+')';});//HTML Content
//File download
