...
if(typeof this.activitiContentUpdate=='function'){this.activitiContentUpdate();}}},{key:'onArrowLeftClick',value:function onArrowLeftClick(dontExecuteActionInSlide){// document.querySelectorAll('.slider-indicators li').forEach((element) => {
