...
document.querySelector('.slider-control.left').setAttribute('onclick','void(0);');document.querySelector('.slider-control.right').setAttribute('onclick','void(0);');this.started=true;}if(document.querySelector('.navbar-bottom .slider-indicators')){this.update();}}else{(0,_debug.cl)("No se muestra la navegación porque está en modo Preview");}}// removeActivitiesSlides(){
// //Remove Buttons
...
if(blink.activity.slidePreview){//Hide back button and TOC button with a class
