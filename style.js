...
})(window, function(__WEBPACK_EXTERNAL_MODULE__52__) {
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};exports.esAlumno=esAlumno;exports.esProfesor=esProfesor;exports.esEditor=esEditor;function esAlumno(){if((typeof blink==='undefined'?'undefined':_typeof(blink))=='object'){return blink.user.esAlumno();}return false;}function esProfesor(){if((typeof blink==='undefined'?'undefined':_typeof(blink))=='object'){return blink.user.esProfesor();}return false;}function esEditor(){if((typeof blink==='undefined'?'undefined':_typeof(blink))=='object'){return blink.user.esEditor();}return false;}
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _urlHelper=__webpack_require__(46);var _urlHelper2=_interopRequireDefault(_urlHelper);var _Transitions=__webpack_require__(45);var _Transitions2=_interopRequireDefault(_Transitions);var _debug=__webpack_require__(1);var _1ScreenHome=__webpack_require__(43);var _1ScreenHome2=_interopRequireDefault(_1ScreenHome);var _2ScreenUnitsMenu=__webpack_require__(40);var _2ScreenUnitsMenu2=_interopRequireDefault(_2ScreenUnitsMenu);var _3ScreenUnit=__webpack_require__(36);var _3ScreenUnit2=_interopRequireDefault(_3ScreenUnit);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}//El hash puede ser
// "#" o "#" => Home
...
if((0,_blinkFunctions.esAlumno)()){data.units.forEach(function(unit){var i=unit.subunits.length;while(i--){//cl('onlyVisibleTeachers '+ unit.subunits[i].title + ' - ' + unit.subunits[i].onlyVisibleTeachers);
if(unit.subunits[i].onlyVisibleTeachers){unit.subunits.splice(i,1);}}i=unit.resources.length;while(i--){if(unit.resources[i].onlyVisibleTeachers){unit.resources.splice(i,1);}}});}(0,_debug.cl)(data.units);data.units.forEach(function(unit){(0,_debug.cl)(unit.title);var i=unit.subunits.length;while(i--){(0,_debug.cl)(unit.subunits[i].title);(0,_debug.cl)(unit.subunits[i].ocultar);}});//If ocultar == true, remove it
