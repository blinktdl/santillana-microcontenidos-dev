...
var _zingtouch=__webpack_require__(61);var _zingtouch2=_interopRequireDefault(_zingtouch);var _debug=__webpack_require__(2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenHome=function(){function ScreenHome(){_classCallCheck(this,ScreenHome);this.state={started:false};this.goto=null;}_createClass(ScreenHome,[{key:'init',value:function init(_ref){var data=_ref.data,goTo=_ref.goTo;console.log('**************************************************  home');blink.getActivity(68,1179).done(console.log);console.log(data);if(!this.started){this.goTo=goTo;var title=data.title,type=data.type,nivel=data.nivel,courseTags=data.courseTags;console.log(data);document.querySelector('#sm-home h1').innerHTML=title;//Nivel
