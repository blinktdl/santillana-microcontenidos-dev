...
module.exports = "<div class=sm-subunit-start> <div class=sm-subunit-start__secuencia> <div class=sm-subunit-start__secuencia__content> <div class=sm-subunit-start__number></div> <div class=sm-subunit-start__title></div> <div class=sm-subunit-start__progress> <div class=sm-subunit-start__progress__title></div> <div class=sm-subunit-start__progress__bar> <div class=sm-color-background-color></div> </div> </div> <div class=sm-subunit-start__start_button>Comienza secuencia didáctica</div> </div> </div> <div class=sm-subunit-start__nav> <div class=active>Secuencia Didáctiva</div> <div>Actividades</div> <div>Ir a evaluación final</div> </div> </div>";
...
//Templates
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _subUnitStart=__webpack_require__(10);var _subUnitStart2=_interopRequireDefault(_subUnitStart);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitStart=function(){function ScreenSubUnitStart(){_classCallCheck(this,ScreenSubUnitStart);this.state={};this.subUnitObject={};}_createClass(ScreenSubUnitStart,[{key:'init',value:function init(subUnitObject){console.log('ScreenSubUnitStart.init()');this.subUnitObject=subUnitObject;console.log("Iniciando pantalla start");document.getElementsByTagName('body')[0].insertAdjacentHTML('beforeend',_subUnitStart2.default);document.querySelector('.sm-subunit-start').style.backgroundImage='url('+this.subUnitObject.image+')';}}]);return ScreenSubUnitStart;}();exports.default=ScreenSubUnitStart;
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _responsiveStatus=__webpack_require__(2);var _responsiveStatus2=_interopRequireDefault(_responsiveStatus);var _getCoords=__webpack_require__(16);var _sliderIndicatorArrowLeft=__webpack_require__(15);var _sliderIndicatorArrowLeft2=_interopRequireDefault(_sliderIndicatorArrowLeft);var _sliderIndicatorArrowRight=__webpack_require__(14);var _sliderIndicatorArrowRight2=_interopRequireDefault(_sliderIndicatorArrowRight);var _sliderIndicatorStartButton=__webpack_require__(13);var _sliderIndicatorStartButton2=_interopRequireDefault(_sliderIndicatorStartButton);var _sliderIndicatorEndButton=__webpack_require__(12);var _sliderIndicatorEndButton2=_interopRequireDefault(_sliderIndicatorEndButton);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitIndicators=function(){function ScreenSubUnitIndicators(){_classCallCheck(this,ScreenSubUnitIndicators);this.state={started:false,contentLeft:0,//tablet y mobile
contentTop:0,//desktop
isStartSlide:false,isEndSlid:false,blinkSlidesLength:0};}_createClass(ScreenSubUnitIndicators,[{key:'init',value:function init(){// if(config.dev)
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _urlHelper=__webpack_require__(35);var _urlHelper2=_interopRequireDefault(_urlHelper);var _Transitions=__webpack_require__(34);var _Transitions2=_interopRequireDefault(_Transitions);var _1ScreenHome=__webpack_require__(32);var _1ScreenHome2=_interopRequireDefault(_1ScreenHome);var _2ScreenUnitsMenu=__webpack_require__(29);var _2ScreenUnitsMenu2=_interopRequireDefault(_2ScreenUnitsMenu);var _3ScreenUnit=__webpack_require__(26);var _3ScreenUnit2=_interopRequireDefault(_3ScreenUnit);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}//El hash puede ser
// "#" o "#" => Home
...
"use strict";
__webpack_require__(40);var _app=__webpack_require__(37);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){SantillanaMicrocontenidosApp.init(data);}};
