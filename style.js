...
data.units.forEach(function(unit){unit.subunitsmain.forEach(function(subunit){if(typeof blink.activity.resourcesList!='undefined'){if(blink.activity.resourcesList){var evaluationSubunitID=blink.activity.resourcesList[0].idactivity;if(subunit.id==evaluationSubunitID){subunit.evaluationSubUnit=_.find(unit.subunitsevaluation,{id:idclase.toString()});_.find(unit.subunitsevaluation,{id:idclase.toString()}).parentSubUnit=subunit;}}}});unit.subunitsevaluation.forEach(function(subunitevaluation){if(typeof blink.activity.resourcesList!='undefined'){if(blink.activity.resourcesList){var evaluationSubunitID=blink.activity.resourcesList[0].idactivity;if(subunitevaluation.id==evaluationSubunitID){subunitevaluation.parentSubUnit=_.find(unit.subunitsmain,{id:idclase.toString()});_.find(unit.subunitsmain,{id:idclase.toString()}).evaluationSubUnit=subunitevaluation;}}}});unit.resourcesmain.forEach(function(subunit){if(typeof blink.activity.resourcesList!='undefined'){if(blink.activity.resourcesList){var evaluationSubunitID=blink.activity.resourcesList[0].idactivity;if(subunit.id==evaluationSubunitID){subunit.evaluationSubUnit=_.find(unit.resourcesevaluation,{id:idclase.toString()});_.find(unit.resourcesevaluation,{id:idclase.toString()}).parentSubUnit=subunit;}}}});unit.resourcesevaluation.forEach(function(subunitevaluation){if(typeof blink.activity.resourcesList!='undefined'){if(blink.activity.resourcesList){var evaluationSubunitID=blink.activity.resourcesList[0].idactivity;if(subunitevaluation.id==evaluationSubunitID){subunitevaluation.parentSubUnit=_.find(unit.resourcesmain,{id:idclase.toString()});_.find(unit.resourcesmain,{id:idclase.toString()}).evaluationSubUnit=subunitevaluation;}}}});});//Add activities progress
