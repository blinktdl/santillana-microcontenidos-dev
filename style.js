...
var infoButtons=document.querySelectorAll('.info-button');_.forEach(infoButtons,function(infoButton){infoButton.classList.add('sm-color-background-color');});this.update();}_createClass(Activities,[{key:'update',value:function update(){//Activitie header book color small block
