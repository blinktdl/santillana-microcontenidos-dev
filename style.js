...
//Get home image
var homeBackgroundImageUrl='';if(this.data.units[0].subunits.length>=1){if(this.data.units[0].subunits[0].image){homeBackgroundImageUrl=this.data.units[0].subunits[0].image;}}//Remove first unit
this.data.units.shift();this.data.homeBackgroundImageUrl=homeBackgroundImageUrl;//If user is student, remove subunits and resources not visible for her
...
var preloadImages=new _ImagesPreload2.default();preloadImages.add(this.data.homeBackgroundImageUrl);//Start menu navigation
