...
})(window, function(__WEBPACK_EXTERNAL_MODULE__48__) {
...
htmlText+='<em>'+node.data+'</em>';}else{htmlText+=node.outerHTML;}});remainBox.innerHTML=htmlText;});//Add image for mobile for fullscreen
// const fullScreenSlides = document.querySelectorAll('.item-container.aux-fullscreen');
// fullScreenSlides.forEach(slide => {
//     const backgroundImg = slide.querySelector('.fs-img-container'),
//     backgroundImgStyle = backgroundImg.currentStyle || window.getComputedStyle(backgroundImg, false),
//     backgroundImgUrl = backgroundImgStyle.backgroundImage.slice(4, -1).replace(/['"]/g, "");
//     const imageDivMobile = document.createElement('div');
//     imageDivMobile.className = 'sm-fs-img-container';
...
var multipleChoiceWorkspaceImages=document.querySelectorAll('.workspace.multiple-choice ul li.opcion img');multipleChoiceWorkspaceImages.forEach(function(img){var ul=null;var elem=img;for(;elem&&elem!==document;elem=elem.parentNode){console.log(elem);if(elem.tagName=='UL'){console.log("ES UL");ul=elem;break;}}ul.classList.add('sm-multiple-choice-images-list');});this.update();}_createClass(Activities,[{key:'update',value:function update(){//Activitie header book color small block
...
this.state.tab='secuencia';}},{key:'goTabActividades',value:function goTabActividades(){if(_config2.default.dev)console.log("goTabActividades");this.updateCompleted();// console.log('goTabSecuenciaDidactica');
...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();//Templates
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _animejs=__webpack_require__(3);var _animejs2=_interopRequireDefault(_animejs);var _responsiveStatus=__webpack_require__(2);var _responsiveStatus2=_interopRequireDefault(_responsiveStatus);var _getCoords=__webpack_require__(22);var _sliderIndicatorArrowLeft=__webpack_require__(21);var _sliderIndicatorArrowLeft2=_interopRequireDefault(_sliderIndicatorArrowLeft);var _sliderIndicatorArrowRight=__webpack_require__(20);var _sliderIndicatorArrowRight2=_interopRequireDefault(_sliderIndicatorArrowRight);var _sliderIndicatorStartButton=__webpack_require__(19);var _sliderIndicatorStartButton2=_interopRequireDefault(_sliderIndicatorStartButton);var _sliderIndicatorEndButton=__webpack_require__(18);var _sliderIndicatorEndButton2=_interopRequireDefault(_sliderIndicatorEndButton);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var ScreenSubUnitIndicators=function(){function ScreenSubUnitIndicators(){_classCallCheck(this,ScreenSubUnitIndicators);this.state={started:false,contentLeft:0,//tablet y mobile
...
_.forEach(buttons,function(button,index){var indexNumber=button.getAttribute('data-go-to');if(indexNumber!=null){if(_this2.subunit.sections.hasOwnProperty(parseInt(indexNumber)+1)){var isMultimedia=_this2.subunit.sections[parseInt(indexNumber)+1].type==7;if(isMultimedia){_this2.lines[index]=document.createElement('div');_this2.lines[index].setAttribute('class','slider-indicators__lines__line');document.querySelector('.navbar-bottom .slider-indicators__lines_container').appendChild(_this2.lines[index]);}}}});//Create lines
...
if(typeof this.activitiContentUpdate=='function'){this.activitiContentUpdate();}}},{key:'onArrowLeftClick',value:function onArrowLeftClick(){// document.querySelectorAll('.slider-indicators li').forEach((element) => {
...
this.activities=new _Activities2.default();this.screenSubUnitIndicators.activitiContentUpdate=this.activities.update;}this.started=true;}},{key:'onGoToActivity',value:function onGoToActivity(page){this.state.inActivity=true;document.querySelector('.slider-indicators li[data-go-to="'+(parseInt(page)-1)+'"]').click();}},{key:'onBackButtonClick',value:function onBackButtonClick(){if(!this.isEvaluacion){// Chec if we are in secuencia o actividades
...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _urlHelper=__webpack_require__(42);var _urlHelper2=_interopRequireDefault(_urlHelper);var _Transitions=__webpack_require__(41);var _Transitions2=_interopRequireDefault(_Transitions);var _1ScreenHome=__webpack_require__(39);var _1ScreenHome2=_interopRequireDefault(_1ScreenHome);var _2ScreenUnitsMenu=__webpack_require__(36);var _2ScreenUnitsMenu2=_interopRequireDefault(_2ScreenUnitsMenu);var _3ScreenUnit=__webpack_require__(32);var _3ScreenUnit2=_interopRequireDefault(_3ScreenUnit);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}//El hash puede ser
// "#" o "#" => Home
...
//Polyfils
__webpack_require__(44);var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _router=__webpack_require__(43);var _router2=_interopRequireDefault(_router);var _bookColors=__webpack_require__(31);var _ImagesPreload=__webpack_require__(30);var _ImagesPreload2=_interopRequireDefault(_ImagesPreload);var _0LeftMenu=__webpack_require__(29);var _0LeftMenu2=_interopRequireDefault(_0LeftMenu);var _ScreenSubUnit=__webpack_require__(24);var _ScreenSubUnit2=_interopRequireDefault(_ScreenSubUnit);var _main=__webpack_require__(9);var _main2=_interopRequireDefault(_main);__webpack_require__(8);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var SantillanaMicrocontenidos=function(){function SantillanaMicrocontenidos(){_classCallCheck(this,SantillanaMicrocontenidos);this.state={isLaunched:false};this.leftMenu=null;}_createClass(SantillanaMicrocontenidos,[{key:'init',value:function init(dataraw){var data=JSON.parse(JSON.stringify(dataraw));if(_config2.default.dev){console.log("app.init()");console.log(data);}if(!this.state.isLaunched){this.state.isLaunched=true;if(_config2.default.dev){console.log('%c Iniciando estilos Santillana ','background: #29495e; color: white');console.log('%c Unidades: '+data.units.length+' ','background: #29495e; color: white');}var urlSeguimiento='/include/javascript/seguimientoCurso.js.php?idcurso='+idcurso;if(typeof loadScript==='function'){//If is blink enviroment
...
"use strict";
__webpack_require__(46);var _app=__webpack_require__(45);var _app2=_interopRequireDefault(_app);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var SantillanaMicrocontenidosApp=new _app2.default();module.exports={init:function init(data){SantillanaMicrocontenidosApp.init(data);}};
