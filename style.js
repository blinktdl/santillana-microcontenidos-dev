...
if(this.subUnitObject.video.length>3){var _videoContainerElement=document.createElement("DIV");_videoContainerElement.classList.add('sm-subunit-start__video');_videoContainerElement.innerHTML='\n                    <video  muted loop autoplay oncanplay="this.muted=true">\n                        <source src="'+this.subUnitObject.video+'" type="video/mp4">\n                        <div style="background-image: url('+this.subUnitObject.image+'))"></div>\n                    </video>\n                ';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__image').insertBefore(_videoContainerElement,document.querySelector('.sm-subunit-start').firstChild);}else if(this.subUnitObject.image.length>3){(0,_debug.cl)("Tiene imagen");document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__image').style.backgroundImage='url('+this.subUnitObject.image+')';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__evaluacion__background').style.backgroundImage='url('+this.subUnitObject.image+')';}else{(0,_debug.cl)("No tiene imagen");document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__image').style.backgroundImage='url('+this.subUnitObject.parentSubUnit.image+')';document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__evaluacion__background').style.backgroundImage='url('+this.subUnitObject.parentSubUnit.image+')';}document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__number').innerHTML=numberString;document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__title').innerHTML=this.subUnitObject.title;this.updateCompleted();document.querySelector('.sm-subunit-start__evaluacion .sm-subunit-start__start_button_content--general .sm-subunit-start__start_button').addEventListener('click',function(){return _this.goFirstBlinkSlide();});}//Añade acciones a los botones tabs
