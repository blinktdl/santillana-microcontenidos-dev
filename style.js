...
document.querySelector('.navbar.libro').classList.add('is-preview');}//If preview or review
if(blink.activity.slidePreview||window.esPopup){//remove all elements of title less last span.ellipsis
