...
var _config=__webpack_require__(0);var _config2=_interopRequireDefault(_config);var _lodash=__webpack_require__(6);var _lodash2=_interopRequireDefault(_lodash);var _jsCookie=__webpack_require__(12);var _jsCookie2=_interopRequireDefault(_jsCookie);var _editarBlockHeader=__webpack_require__(11);var _editarBlockHeader2=_interopRequireDefault(_editarBlockHeader);var _debug=__webpack_require__(2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var EditarBloques=function(){function EditarBloques(){_classCallCheck(this,EditarBloques);}_createClass(EditarBloques,[{key:'init',value:function init(units){var _this=this;//First of all, create an array with blocks info with
...
headerDomHtml=headerDomHtml.replace('--TITULO--',block.headerSubUnit.data.title);block.containerDomElement.insertAdjacentHTML('afterbegin',headerDomHtml);//remove headerSubunit. We don't need it
...
var containerList=document.createElement('ul');containerList.classList.add('sm-editar-block__subunits');containerContent.appendChild(containerList);//Insert it in block
...
console.log(data.units[7].subunits);//Activities list
