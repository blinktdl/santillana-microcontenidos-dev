...
});var smStylesEditInit=function smStylesEditInit(data){console.log('%c Santillana Microcontenidos ','font-size: 40px; font-weight: 700; color: white; background-color: #2a495d;');console.log('Fecha de compilación: 2019-12-18 10:53:52 AM.');console.log("Iniciando...");console.log("Datos cargados.");//indow.losdatos = data;
...
var selectElements=document.querySelectorAll('select.publication-status');selectElements.forEach(function(selectElement){selectElement.dataset.valueForCss=selectElement.value;selectElement.addEventListener('change',function(e){selectElement.dataset.valueForCss=selectElement.value;});});};
